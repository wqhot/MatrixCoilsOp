...
% targetROI：目标磁场
%%
function finalCoilsMatrix=GAoptPar(coilsMatrix,ROI,crossoverP,mutationP,pop,G,target,targetROI)
    tic;
    global defaultN;
    global LbtwUD;
    ...
    tempCoilsMatrix=repmat(coilsMatrix,pop,1);
    ...
    for i=1:G
        ...
        sumFitness=0;      
        parfor j=1:pop          
            Bs=ROIcalNew(ROI,tempCoilsMatrix((j-1)*pop+1:j*pop,:),LbtwUD,400);
